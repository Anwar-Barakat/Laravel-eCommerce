                 ...
                 <tbody class="table-tbody">
                     @forelse ($exchangedOrders as $request)
                         <tr>
                             ...
                             <td>
                                 <button type="button" class="btn btn-sm" data-bs-placement="top" data-bs-toggle="popover" title="{{ __('order.return_reason') }}" data-bs-content="{{ __('frontend.' . App\Models\OrderLog::RETURNEXCHANGEREASON[$request->reason]) }}">{{ __('btns.click_here') }}</button>
                             </td>
                             <td>
                                 <div>
