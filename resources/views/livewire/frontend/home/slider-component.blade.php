         ...
         @foreach ($banners as $banner)
             <div class="hero-slide">
                 @if ($banner->getFirstMediaUrl('banners', 'thumb'))
                     <img src="{{ $banner->getFirstMediaUrl('banners', 'thumb') }}" alt="{{ $banner->title }}" class="absolute opacity-65">
                 @endif
                 <div class="container">
                     <div class="row">
                         <div class="col-12">
                             <div class="slider-content slider-content--animation">
                                 ...
                                 <span class="content-span-3 u-c-secondary text-3xl">Find {{ $banner->title }} on best prices, Also Discover most selling products of {{ $banner->title }}</span>
