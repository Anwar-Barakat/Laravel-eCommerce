    ...
    <form class="checkout-f__delivery" wire:submit.prevent='submit'>
        <div class="u-s-m-b-30">
            ...
            <div class="u-s-m-b-10">
                <!--====== Check Box ======-->
                <div class="check-box">
                    <input type="checkbox" id="make-default-address" wire:model='address.is_default'>
                    <div class="check-box__state check-box__state--primary">
            ...
            <div>
                <button class="btn btn--e-transparent-brand-b-2" type="submit">{{ __('btns.submit') }}</button>
            </div>
        </div>
    </form>
</div>
