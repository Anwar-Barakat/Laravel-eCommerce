<aside class="navbar navbar-vertical navbar-expand-lg navbar-dark">
    <div class="container-fluid">
        ...
        <h1 class="navbar-brand navbar-brand-autodark">
            <a href=".">
                <img src="{{ asset('backend/static/logo-white.svg') }}" width="110" height="32" alt="Tabler" class="navbar-brand-image">
            </a>
        </h1>
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item dropdown {{ request()->routeIs('admin.sections.index') ? 'active' : '' }}">
                    ...
                    <div class="dropdown-menu {{ request()->routeIs('admin.sections.*') ? 'show' : '' }}">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a href="{{ route('admin.sections.index') }}" class="dropdown-item {{ request()->routeIs('admin.sections.index') ? 'active' : '' }}">
                                    {{ __('msgs.list', ['name' => __('section.sections')]) }}
                                </a>
                                <a href="{{ route('admin.sections.create') }}" class="dropdown-item {{ request()->routeIs('admin.sections.create') ? 'active' : '' }}">
                        ...
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a href="{{ route('admin.products.index') }}" class="dropdown-item {{ request()->routeIs('admin.products.index') ? 'active' : '' }}">
                                    {{ __('msgs.list', ['name' => __('product.products')]) }}
                                </a>
